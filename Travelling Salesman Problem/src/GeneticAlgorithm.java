...
/**
 * The GeneticAlgorithm class contains all the functions of the genetic
 * algorithm such as crossover,
 * mutation, fitness evaluation and termination condition checking.
 */
public class GeneticAlgorithm {
    ...
    /**
     * Create new instance of the GeneticAlgorithm class with required
     * configuration.
     *
     * @param populationSize number of individuals in population
     * @param mutationRate   probability that a gene will be mutated
     * @param crossoverRate  rate of solutions that will have a crossover
     * @param elitismCount   individuals with strong fitness
     * @param tournamentSize number of individuals to compete in tournament
     */
     ...
     * condition the allowed number of generations has been exceeded.
     * 
    ...
    /**
     * Crossover is applied to the population
     *
     * @param population population
     * @return new population with new offsprings
     */
    ...
    /**
     * Mutation is applied to the population.
     *
     * @param population population
